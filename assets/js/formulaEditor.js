...
/*
Derived work from mathquill4quill (https://github.com/c-w/mathquill4quill/tree/master).
Author : Narendar Reddy S
Organisation : Amplelogic
Dependencies : MathQuill, Katex
Use mathquill4quill to provide formula support for Editor control
*/
window.formulaEditor = function(dependencies) {
  ...
  function enableMathQuillFormulaAuthoring(editor, options) {
    options = options || {};

    function areAllDependenciesMet() {
      if (!Editor) {
        console.log("Editor is not loaded"); // eslint-disable-line no-console
        return false;
      }
    ...
    function getTooltip() {
      return editor.container.getElementsByClassName("al-mq-menu")[0];
    }

    function getSaveButton() {
      const tooltip = getTooltip();
      return tooltip.getElementsByClassName("al-mq-btn")[0];
    }
    ...
    function newMathquillInput() {
      ...
      function syncMathquillToEditor(latexInput, saveButton) {
        const handlers =
      ...
      return {
        render() {
          ...
          mqField = syncMathquillToEditor(latexInput, saveButton);
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = window.formulaEditor;
}
